            ...
            <div class="bg-neutral-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-white">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="{{ route('admin.news.create') }}" class="bg-white hover:bg-gray-200 text-black font-bold py-3 px-6 rounded-lg shadow-lg hover:shadow-xl transition duration-200 flex items-center space-x-2">
                            ...
                            <tbody class="bg-neutral-800 divide-y divide-neutral-700">
                                @foreach($newsPosts as $post)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-400">{{ $post->slug }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-400">{{ $post->published_at->format('d/m/Y H:i') }}</td>
