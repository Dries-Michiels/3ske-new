                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('admin.faq-items.update', $faqItem) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="question" id="question" value="{{ old('question', $faqItem->question) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                        </div>

                        <div class="mb-4">
                            <label for="answer" class="block text-sm font-medium text-gray-700">Answer</label>
                            <textarea name="answer" id="answer" rows="6" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>{{ old('answer', $faqItem->answer) }}</textarea>
                        </div>
